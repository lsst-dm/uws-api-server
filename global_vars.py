...
TARGET_CLUSTER = os.environ['TARGET_CLUSTER'] if 'TARGET_CLUSTER' in os.environ else 'int'
PROJECT_SUBPATH = os.environ['PROJECT_SUBPATH'] if 'PROJECT_SUBPATH' in os.environ else ''
