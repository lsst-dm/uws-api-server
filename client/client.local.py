...
## Set an environment variable UWS_USER_PASS with the basic auth credentials
...
if __name__ == "__main__":
    ...
    #     RUN_OPTIONS="-c isr:doBias=False -c isr:doDark=False
    #                  -c isr:doFlat=False -c isr:doFringe=False
    #                  -c isr:doLinearize=False -c isr:doDefect=False
    #                  -i LATISS/raw/all",
    #     DATA_QUERY="instrument='LATISS' AND exposure.day_obs=20210414 AND
    #                 exposure.seq_num=2",
    #     OUTPUT_GLOB='*',
    # )
    ...
    payload_env = {"CUSTOM_ENV_VAR": "Hello OCPS!"}
    ...
    create_response = create_job(
        ...
        environment=[{"name": k, "value": v} for k, v in payload_env.items()],
    )
